...
Print.prototype = {
  ...
  getHtml: function () {
    ...
    // let arr = document.querySelectorAll('canvas')  //哪怕深拷贝传入的整个dom也不行  canvans无法被拷贝
    // var div = document.createElement('div')
    // arr.forEach(v => {
    //   div.appendChild(v.cloneNode(true))
    // })
    // console.log('div', div)
    // let canvass = div.querySelectorAll('canvas')
    // console.log('深拷贝后的canvans', canvass)
    // return false
    ...
    for (var k4 = 0; k4 < canvass.length; k4++) {
      ...
      if (canvass[k4].className == 'watermark') {
        continue
      }
