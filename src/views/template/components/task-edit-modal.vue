<template>
  <a-modal v-bind="options" @cancel="handleCancel">
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-form-model-item label="任务名称" prop="taskName">
          <a-input v-model.trim="form.taskName" placeholder="请输入任务名称" />
        </a-form-model-item>
        ...
        <a-form-model-item label="产品描述" prop="description">
          <a-textarea v-model.trim="form.description" placeholder="请输入产品描述"></a-textarea>
        </a-form-model-item>
      </a-form-model>
    </a-spin>
    ...
    <template #footer>
      ...
      <a-button type="primary" :loading="submitLoading" :disabled="loading" @click="handleOk">提交</a-button>
    </template>
  </a-modal>
</template>
