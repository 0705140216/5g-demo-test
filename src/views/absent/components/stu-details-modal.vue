    ...
    <a-spin :spinning="loading">
      <a-form-model class="isView" :model="form" :label-col="labelCol" :wrapper-col="wrapperCol">
        ...
        <a-form-model-item label="请假类型">
          <span>{{ form.notCheckType | leaveStatus }}</span>
        </a-form-model-item>

        <a-form-model-item label="病因">
          <span>{{ form.pathogeny }}</span>
        </a-form-model-item>

        <a-form-model-item label="症状">
          <span>{{ form.symptom }}</span>
        </a-form-model-item>
        ...
        <a-form-model-item label="审批人">
          <span>{{ form.approveedBy }}</span>
        </a-form-model-item>

        <a-form-model-item label="审批时间">
          <span>{{ form.approveTime }}</span>
        </a-form-model-item>
